...
def run_long_only_backtest(
    ...
    """
    Apply long-only position (0 or 1) with one-day delay: return at t uses position from t-1.

    position must be aligned with close; uses previous day's signal to avoid lookahead.
    Commission is charged on absolute position change * (commission_rate).
    """
